<script>
  ...
  <div class="{isOpen ? 'translate-x-0' : 'translate-x-full'} fixed top-0 right-0 h-full max-w-[400px]  w-[90%] bg-black text-white transition-transform duration-300 ease-in-out z-50">
    ...
    <ul class="py-6 text-xl font-extralight flex flex-col">
      ...
      <li><a href="#" class="block px-8 py-4 border-b-[1px] hover:bg-gray-900">Menú</a></li>
      <li><a href="#" class="block px-8 py-4 border-b-[1px] hover:bg-gray-900">Vinos</a></li>
      <li><a href="#" class="block px-8 py-4 border-b-[1px] hover:bg-gray-900">Eventos</a></li>
      <li><a href="#" class="block px-8 py-4 border-b-[1px] hover:bg-gray-900">Contacto</a></li>
      {#if isLoggedIn}
